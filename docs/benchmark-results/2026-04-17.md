# AI 모델 벤치마크 결과 — 2026-04-17

> **측정일**: 2026-04-17
> **대상**: Claude Sonnet 4.5 / GPT-5.1 / Gemini 2.5 Pro
> **범위**: 30 cases × 10 runs × 3 models = 총 900 pipelines
> **관련 문서**: `docs/spec/ai-assist-SPEC.md` (모델 선정 ADR 본문)
